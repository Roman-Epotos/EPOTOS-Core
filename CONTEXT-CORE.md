...
POST /api/assistant/chat
  ...
  — Ищет контекст → промпт → google/gemini-2.5-flash
...
Асинхронная генерация:
  ...
  Фронтенд: после обновления страницы файл появляется в списке (нормально)

Извлечение текста из DOCX: JSZip → word/document.xml → убираем XML теги

AI модель: google/gemini-2.5-flash (НЕ gemini-2.0-flash-001 — та модель недоступна)
...
=============================================================
8. ГДЕ ОСТАНОВИЛИСЬ (09.06.2026 вечер)
=============================================================
Сделано:
...
Следующие задачи:
  1. Загрузить инструкцию пользователя ЮрИнтел → первый документ базы знаний
  2. Тестирование поиска и чата с реальным контентом
  3. ЭПОТОС-ПЕРСОНАЛ
