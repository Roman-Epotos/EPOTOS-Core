...
5. API
=============================================================
POST /api/assistant/upload — загрузка DOCX/TXT, maxDuration=60
...
6. АРХИТЕКТУРА
=============================================================
Эмбеддинги: google/gemini-embedding-001, vector(768), чанки ~2000 символов
Асинхронная генерация: сохраняем чанки → success → эмбеддинги в фоне
